          ...
          <div class="page-header">
            ...
            <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
              ...
              <ul class="quick-links ml-auto">
                <li><a href="#">@if(\Auth::user()->inRole('client'))Settings @endif</a></li>
...
function myFunction() {
  ...
  cell1.innerHTML = '<input class="form-control text-center no_units" min="1"  type="text"name="item_quantity[]" value="1">';
  cell2.innerHTML = '<input class="form-control text-center no_units" min="1"  type="text"name="item_quantity[]" value="1">';
}
</script>
 --}}
